...
def MYSQLconnectionCheck ():
    ...
    if myConnection:
        ...
        cursor.execute("CREATE DATABASE IF NOT EXISTS PHONEIX")
...
def MYSQLconnection ():
    ...
    global myConnection
    global cid
    myConnection = mysql.connector.connect(host="localhost", user=userName, passwd = password, database = "PHONEIX",
...
print("#*SRI CHAITANYA PU COLLEGE  *")
print("#***WELCOME TO THE MALL OF PHONEIX")
print("################## THE MALL OF PHONEIX ##########")
print("#***Designed and Maintained By:")
print("#***KANISHKA - CLASS XII ")
print("#***MUBASHEER - CLASS XII ")
...
if myConnection:
    ...
    while (True):
        ...
        if choice == 1:
            ...
            print("Thanks for visitng THE MALL OF PHONEIX \n * We are eagerly awaititng for your next visit !!! ** ")
            break
        else:
            print("Sorry ,May Be You Are Giving Me Wrong Input, Please Try Again !!! ")
else:
