...
def acer():
    ...
    f2.place(x=0, y=45)
    l2 = Label(f2, text='Wagon wheel', fg='black', bg='white')
...
def dell():
    ...
    f2 = Frame(w, width=900, height=455, bg='white')
    f2.place(x=0, y=45)
    l2 = Label(f2, text='Player stats', fg='black', bg='white')
    l2.config(font=('Comic Sans MS', 50))
...
def toggle_win():
    ...
    bttn(0, 117, 'W A G O N W H E E L', '#0f9d9a', '#12c4c0', acer)
    bttn(0, 154, 'P L A Y E R  S T A T S', '#0f9d9a', '#12c4c0', dell)
    bttn(0, 191, 'L O G I N', '#0f9d9a', '#12c4c0', None)
    bttn(0, 228, 'S I G N  U P', '#0f9d9a', '#12c4c0', None)
    bttn(0, 265, 'M A T C H  S C O R E S', '#0f9d9a', '#12c4c0', None)
    ...
    global img2
    img2 = ImageTk.PhotoImage(Image.open("c1.png"))
